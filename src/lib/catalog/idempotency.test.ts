...
function fonteDoAudit(): string {
  // A Mass Ingestion 1 mantém um executor separado para as novas fontes. O
  // contrato offline deve considerar os dois, exatamente como package.json.
  return [
...
describe("audit de fontes", () => {
  ...
  it("cobre toda fonte registrada", () => {
    ...
    // Este teste impede registry e executores de divergirem em silêncio.
