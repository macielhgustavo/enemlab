...
const SPECS: FatecSpec[] = [
  {
    ...
    total: 54,
    answers: "BCDBBCCBECCCAEDABBCBECABBDEBBEECBCEEDAABCCDEEE DABCCEDD".replace(/ /g, ""),
  ...
  },
  {
    ...
    total: 54,
    answers: "DEBADC D CEDADCCBDCBCADBDBDEE A DEBCEEACADDBECDCCBBCDBBC".replace(/ /g, ""),
  ...
  },
  {
    ...
    total: 54,
    answers: "CDBABDEA EEDDC ECAEBDEE CBBECCEEBAD E CDEAAXBACABCEBBDD AEBE".replace(/ /g, ""),
  ...
  },
  {
    ...
    total: 54,
    answers: "DCCADCDDACA EABEA DDEACEEDED B ADEAEDCBDDCCAEDDBDDAEAEDEBC".replace(/ /g, ""),
  ...
  },
  {
    ...
    total: 54,
    answers: "BDEEDCEDDAEBDBACDDEDECCDDEADEADDEE DCAD AECB DCCECB AEDACE".replace(/ /g, ""),
  ...
  },
  {
    ...
    total: 64,
    answers: "CEEDDDECCE AADC AACDCECECBDCEADEBBAD ADEEAB BDBEBDCCECDDEBEDAEBDAECE".replace(/ /g, ""),
  ...
  },
  {
    ...
    total: 60,
    answers: "CABCECAAEBEDCBEEBBEDBACECABDEDDABCCA EDE EBCDCDADC AEEEAAADBDAB".replace(/ /g, ""),
  ...
  },
  {
    ...
    total: 60,
    answers: "DCBEECDBDAEBBADEBDCADD BBCBCBCDDEACEADCBDEBCDADDBCAEEACACBCBD".replace(/ /g, ""),
