 ...
 * source that passed the ingestion/review pipeline may publish question data.
 */
export type DiscoverySourceRole = "official" | "discovery-only";
export type DiscoveryValidationLevel = "verified" | "reviewed" | "provisional" | "blocked";
...
export interface DiscoveredExam {
  ...
  /** Required before an official discovery result can be published to the catalog. */
  validationLevel?: DiscoveryValidationLevel;
